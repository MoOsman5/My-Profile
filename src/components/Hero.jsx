    ...
    <section className="relative w-full h-screen mx-auto overflow-hidden">
      ...
      >
        ...
        <div className="z-10 w-full">
          ...
          <p className={`${styles.heroSubText} mt-2 text-white h-[40px] flex items-center`}>
          ...
          <div className="mt-8 flex flex-wrap gap-4 items-center">
            ...
            <a
              href="#contact"
              className="border border-[#915eff]/40 py-3 px-6 rounded-xl text-white font-bold hover:bg-[#915eff]/10 hover:border-[#915eff] transition-all duration-300 transform hover:scale-105 shadow-md flex items-center gap-2"
            >
              Get In Touch
            </a>
